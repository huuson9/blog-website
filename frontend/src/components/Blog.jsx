...
const Blog = (props) => {
  ...
  return (
    <div className="w-2/3">
      <div className="flex flex-row-reverse p-3 border shadow-xl rounded-2xl bg-primary-neutral border-primary-neutral gap-9">
        <div>
          <img
        ...
        <div className="flex flex-col max-w-md ">
          <div className="flex flex-col gap-5 ">
            ...
            <div className="flex flex-row px-4 pt-4 md:justify-between">
